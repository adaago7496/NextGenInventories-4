...
namespace NextGenInventories_4.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public IngredientsController(NextGenInventories_4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Ingredient != null ? 
                          ...
                          Problem("Entity set 'NextGenInventories_4Context.Ingredient'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'NextGenInventories_4Context.Ingredient'  is null.");
            }
            var ingredient = await _context.Ingredient.FindAsync(id);
            if (ingredient != null)
            {
