...
namespace NextGenInventories_4.Controllers
{
    public class InventoriesController : Controller
    {
        ...
        public InventoriesController(NextGenInventories_4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("InventoryId,UserId,ProductId,Quantity")] Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventoryId,UserId,ProductId,Quantity")] Inventory inventory)
        {
