...
{
    public class InventoriesController2 : Controller
    {
        private readonly NextGenInventories_4Context _context;

        public InventoriesController2(NextGenInventories_4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("InventoryId,UserId,ProductId")] Inventory inventory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InventoryId,UserId,ProductId")] Inventory inventory)
        {
